    ...
    public static void init() {
        if (ProjectKorra.plugin.getConfig().getString("Storage.engine").equalsIgnoreCase("mysql")) {
            ...
            if (!sql.tableExists("pk_presets")) {
                ...
                query = "CREATE TABLE `pk_presets` (`uuid` varchar(36) NOT NULL,`name` varchar(255) NOT NULL,`slot1` varchar(255),`slot2` varchar(255),`slot3` varchar(255),`slot4` varchar(255),`slot5` varchar(255),`slot6` varchar(255),`slot7` varchar(255),`slot8` varchar(255),`slot9` varchar(255), PRIMARY KEY (uuid, name));";
                sql.modifyQuery(query);
            }
        } else {
            String query;
            ...
            if (!sql.tableExists("pk_players")) {
                ProjectKorra.log.info("Creating pk_players table.");
                query = "CREATE TABLE `pk_players` (`uuid` TEXT(36) PRIMARY KEY,`player` TEXT(16),`element` TEXT(255),`permaremoved` TEXT(5),`slot1` TEXT(255),`slot2` TEXT(255),`slot3` TEXT(255),`slot4` TEXT(255),`slot5` TEXT(255),`slot6` TEXT(255),`slot7` TEXT(255),`slot8` TEXT(255),`slot9` TEXT(255));";
                sql.modifyQuery(query);
            }
            if (!sql.tableExists("pk_presets")) {
                ProjectKorra.log.info("Creating pk_presets table");
                query = "CREATE TABLE `pk_presets` (`uuid` TEXT(36),`name` TEXT(255),`slot1` TEXT(255),`slot2` TEXT(255),`slot3` TEXT(255),`slot4` TEXT(255),`slot5` TEXT(255),`slot6` TEXT(255),`slot7` TEXT(255),`slot8` TEXT(255),`slot9` TEXT(255),PRIMARY KEY (uuid, name));";
                sql.modifyQuery(query);
            }
        }
    }
